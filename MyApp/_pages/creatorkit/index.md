...
<div class="not-prose hide-title bg-white dark:bg-black pb-12">
    <h1 class="pb-12 text-6xl md:text-7xl lg:text-8xl font-bold tracking-tighter leading-tight md:leading-none text-center">
        Creator Kit
    </h1>
