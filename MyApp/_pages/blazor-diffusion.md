...
<div class="not-prose my-8 flex justify-center">
    <a href="https://github.com/NetCoreApps/BlazorDiffusionVue" class="flex items-center hover:no-underline">
...
[![](/img/pages/blazor/blazordiffusion.com_splash.png)](https://github.com/NetCoreApps/BlazorDiffusionVue)


[Blazor Diffusion](https://github.com/NetCoreApps/BlazorDiffusionVue) is a new ServiceStack.Blazor App front-end for [Stable Diffusion](https://en.wikipedia.org/wiki/Stable_Diffusion) - a deep learning text-to-image model that can generate quality images from a text prompt whose ability to run on commodity GPU hardware makes it 
