...
[HTTP Session](/auth/sessions)
model where after successful authentication a 
[Typed Users Session](/auth/sessions#using-typed-sessions-in-servicestack)
...
Like all of [ServiceStack's Auth Providers](/auth/authentication-and-authorization)
...
[TypeConstants](https://github.com/ServiceStack/ServiceStack/blob/main/ServiceStack.Text/src/ServiceStack.Text/TypeConstants.cs) 
