...
<div class="not-prose mt-8 grid grid-cols-2 gap-4">
    ...
    <a class="block group border hover:border-indigo-700" href="https://vue-spa.web-templates.io">
        <img class="p-2 max-h-[301px]" src="https://raw.githubusercontent.com/ServiceStack/Assets/master/csharp-templates/vue-spa.png">
        <div class="bg-gray-50 text-gray-600 font-semibold group-hover:bg-indigo-700 group-hover:text-white text-center py-2">vue-static.web-templates.io</div>
    </a>
</div>
...
To help choosing which template to start with, here's a quick summary of their differences:
 ...
 - **vue-static** - Want to use TypeScript in a simpler JAMStack Vite SPA App
 - **vue-spa** - Want to use TypeScript in a full-featured JAMStack Vite SPA App
