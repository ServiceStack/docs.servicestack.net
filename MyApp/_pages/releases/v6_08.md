...
The [vue-static](https://vue-static.web-templates.io) and [vue-ssg](https://vue-ssg.jamstacks.net) templates have been upgraded to use the latest
...
<figure class="mt-4">
    <a class="my-8 max-w-4xl mx-auto block" href="https://vue-static.web-templates.io/bookings"><img class="bg-gray-50 shadow hover:shadow-lg" src="/img/pages/release-notes/v6.8/vue-autoquerygrid.png" alt=""></a>
</figure>
