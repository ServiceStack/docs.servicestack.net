---
title: ServiceStack 2016 Release Notes Summary
---
...
Gistlyn's Github Repo provides a good example of a modern medium-sized ServiceStack, React + TypeScript App that takes advantage of a number of different ServiceStack Features:
 ...
 - [Github OAuth](/auth/authentication-and-authorization#auth-providers) -
 authentication with Github
 - [JWT Auth Provider](/auth/jwt-authprovider) - enabling both JWT and JWE ecrypted stateless Sessions
...
See [ApiPostgreSqlTestsAsync.cs](https://github.com/ServiceStack/ServiceStack/blob/main/ServiceStack.OrmLite/tests/ServiceStack.OrmLiteV45.Tests/ApiPostgreSqlTestsAsync.cs)
