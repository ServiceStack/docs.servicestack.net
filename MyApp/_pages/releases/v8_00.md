  ...
  <div class="pt-8 overflow-hidden sm:pt-12 lg:relative lg:py-48">
    <div class="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl lg:grid lg:grid-cols-2 lg:gap-24">
      <div>
        ...
        <div class="mt-20">
          <div>
            <a href="https://github.com/NetCoreApps/TalentBlazor" class="inline-flex space-x-4">
...
The new Identity Auth integration is contained in the .NET 8+ **ServiceStack.Extensions** NuGet package:
