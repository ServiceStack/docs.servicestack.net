...
new `/types/typescript` route so you can get both concrete types and interface defintions at:
  ...
  - [/types/typescript](https://test.servicestack.net/types/typescript) - for generating concrete module and classes
  - [/types/typescript.d](https://test.servicestack.net/types/typescript.d) - for generating ambient interface definitions
...
[![](https://raw.githubusercontent.com/ServiceStack/Assets/master/img/release-notes/typelinks.png)](https://test.servicestack.net/types)
...
available in our [pre-release v4.0.49 NuGet packages](/pre-release).
...
fixed in the [pre-release v4.0.49 NuGet packages](/pre-release).
