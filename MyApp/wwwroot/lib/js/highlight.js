...
/*! `bash` grammar compiled for Highlight.js 11.11.1 */
  ...
  */
  ...
  })();/*! `zig` grammar — Zig isn't included in the highlight.js distribution */
  (function(){
    var hljsGrammar = (function () {
  'use strict';
  ...
  function zig(hljs) {
    ...
    const TYPES = [
      "anyerror", "anyopaque", "bool", "comptime_float", "comptime_int", "f16", "f32", "f64",
      "f80", "f128", "i8", "i16", "i32", "i64", "i128", "isize", "noreturn", "type", "u8",
      "u16", "u32", "u64", "u128", "usize", "void",
      "c_char", "c_int", "c_long", "c_longdouble", "c_longlong", "c_short",
      "c_uint", "c_ulong", "c_ulonglong", "c_ushort"
    ];
    const LITERALS = [ "false", "null", "true", "undefined" ];
    ...
    return {
      ...
      contains: [
        hljs.COMMENT('//', '$', {
          contains: [ { scope: 'doctag', begin: '//[!/]' } ]
        }),
        // multiline string literals are a run of \\-prefixed lines
        {
          scope: 'string',
          begin: /\\\\/,
          end: /$/
        ...
        // builtins are always @-prefixed, e.g. @intCast, @import
        {
          scope: 'built_in',
          begin: /@[a-zA-Z_]\w*/
        },
        ...
        // Zig convention: types are PascalCase
        {
          scope: 'type',
          begin: /\b[A-Z]\w*/,
          relevance: 0
  ...
  return zig;
    ...
    hljs.registerLanguage('zig', hljsGrammar);
  })();
