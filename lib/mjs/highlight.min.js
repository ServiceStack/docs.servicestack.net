...
;hljs.registerLanguage("clojure",e)})();/*! `csharp` grammar compiled for Highlight.js 11.11.1 */
...
;hljs.registerLanguage("dockerfile",e)})();/*! `dts` grammar compiled for Highlight.js 11.11.1 */
...
;hljs.registerLanguage("dts",e)})();/*! `fsharp` grammar compiled for Highlight.js 11.11.1 */
...
})})();hljs.registerLanguage("gradle",e)})();/*! `handlebars` grammar compiled for Highlight.js 11.11.1 */
...
end:"$",illegal:"\n"},o]}}})();hljs.registerLanguage("kotlin",e)})();/*! `lisp` grammar compiled for Highlight.js 11.11.1 */
(()=>{var e=(()=>{"use strict";return e=>{
...
;hljs.registerLanguage("markdown",e)})();/*! `pgsql` grammar compiled for Highlight.js 11.11.1 */
(()=>{var E=(()=>{"use strict";return E=>{
...
aliases:["yml"],contains:r}}})();hljs.registerLanguage("yaml",e)})();/*! `zig` grammar - Zig isn't included in the highlight.js distribution */(()=>{var e=(()=>{"use strict";return e=>({name:"Zig",aliases:["zig"],keywords:{keyword:["addrspace","align","allowzero","and","anyframe","anytype","asm","async","await","break","callconv","catch","comptime","const","continue","defer","else","enum","errdefer","error","export","extern","fn","for","if","inline","linksection","noalias","noinline","nosuspend","opaque","or","orelse","packed","pub","resume","return","struct","suspend","switch","test","threadlocal","try","union","unreachable","usingnamespace","var","volatile","while"],type:["anyerror","anyopaque","bool","comptime_float","comptime_int","f16","f32","f64","f80","f128","i8","i16","i32","i64","i128","isize","noreturn","type","u8","u16","u32","u64","u128","usize","void","c_char","c_int","c_long","c_longdouble","c_longlong","c_short","c_uint","c_ulong","c_ulonglong","c_ushort"],literal:["false","null","true","undefined"]},contains:[e.COMMENT("//","$",{contains:[{scope:"doctag",begin:"//[!/]"}]}),{scope:"string",begin:/\\\\/,end:/$/},e.QUOTE_STRING_MODE,{scope:"string",begin:/'/,end:/'/,illegal:/\n/,contains:[e.BACKSLASH_ESCAPE]},{scope:"built_in",begin:/@[a-zA-Z_]\w*/},e.C_NUMBER_MODE,{scope:"title.function",begin:/\bfn\s+/,end:/[\s(]/,excludeBegin:!0,excludeEnd:!0},{scope:"type",begin:/\b[A-Z]\w*/,relevance:0}]})})();hljs.registerLanguage("zig",e)})();
